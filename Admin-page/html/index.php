                        ...
                        <tr>
                          ...
                          <td><?php echo $row['rented_date'] ?>
                            ...
                            <td>
                              ...
                              <?php
                              if ($row['car_status'] == 'Garage') {
                                echo 'bg-primary'; // Blue background for Garage
                              } elseif ($row['car_status'] == 'Running') {
                                echo 'bg-warning'; // Yellow background for Running
                              } else {
                                echo 'bg-danger'; // Red background for other statuses
                              }
                              ?>
                              ">
                                ...
                                <div class="row">
                                  <div class="col">
                                    <div class="d-flex justify-content-between">
                                      ...
                                      <a class="btn btn-primary" href="arrived-edit.php?car_id=<?php echo $row['car_id']; ?>">Edit</a>
                                    </div>
                                  </div>
                                </div>
                              </div>
